...
test_mean_list = [-0.12, -0.10, -0.08, -0.06, -0.04, -0.02, -0.01, -0.004, 0.0, 0.004, 0.01, 0.02, 0.04, 0.06, 0.08, 0.10, 0.12]
test_mean_pos = [0.0, 0.004, 0.04, 0.08, 0.10, 0.12]
test_mean_neg = [-0.12, 0.10, -0.08, -0.04, -0.004, 0.0]
